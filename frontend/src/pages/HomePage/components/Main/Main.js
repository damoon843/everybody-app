...
function Main() {
  ...
  const renderWorkouts = () => {
    setWorkouts(sampleData.map((exercise) => <Workout title={exercise.title} duration={exercise.duration} user={exercise.user} thumbnail={exercise.thumbnail}/>))
  }
